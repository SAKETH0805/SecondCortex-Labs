...
async def get_team_daily_summary(team_id: str, user_id: str = Depends(get_current_user)):
    """
...
async def get_team_weekly_summary(team_id: str, user_id: str = Depends(get_current_user)):
    """
